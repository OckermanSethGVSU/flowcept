...
replace_word_in_file(f"resources/{target_file}", "resources/multi_node_settings.yaml","MQlocalhost", f"{ip_address}")
replace_word_in_file("resources/multi_node_settings.yaml", "resources/multi_node_settings.yaml","PLACEHOLDER", f"{bs}")


with open("base_node_ip.txt", "w") as f:
